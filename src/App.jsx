...
function App() {
  ...
  return (
    ...
    <form
      ...
      className="w-full md:w-2/3 lg:w-1/2 xl:w-1/3 text-center rounded-lg shadow-lg card py-6 px-4 transition-all duration-500 transform hover:scale-105"
    >
      <a href="" target="_blank" rel="noopener noreferrer">
        <h1 className="text-4xl font-bold text-blue-500 mb-4 animate-bounce">Jiggu AI</h1>
      </a>
      <textarea
        required
